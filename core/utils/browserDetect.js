function browserDetect() {
	...
	obj.isWindowPhone =
		obj.agent.indexOf("IEMobile") > -1 ||
		obj.agent.indexOf("Windows Phone") > -1
	...
	obj.isIOS =
		(obj.agent.indexOf("iPod") > -1 ||
			obj.agent.indexOf("iPhone") > -1 ||
			obj.agent.indexOf("iPad") > -1) &&
		!obj.isWindowPhone
	obj.isAndroid = obj.agent.indexOf("Android") > -1 && !obj.isWindowPhone
	obj.isBlackberry = obj.agent.indexOf("Blackberry") > -1
	obj.isPc = !/(iPhone|iPad|iPod|iOS|Android)/i.test(navigator.userAgent)
